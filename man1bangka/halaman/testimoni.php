...
<section class="testimoni-section" style="padding:4rem clamp(1rem,5vw,4rem);">
  ...
  <div class="testimoni-slider" style="overflow:hidden;max-width:1200px;margin:0 auto;">
    <div class="testimoni-track" id="testimoni-track">
      <div class="testimoni-card"><div class="quote">"</div><p class="text">Memuat testimoni...</p></div>
    </div>
  </div>
        ...
        <div class="form-grid">
          ...
          <div class="form-group">
            ...
            <option value="">-- Pilih Kelas --</option>
                ...
                <option>10D</option><option>10E</option><option>10F</option>
                <option>11A</option><option>11B</option><option>11C</option>
                <option>11D</option><option>11E</option><option>11F</option>
                <option>12A</option><option>12B</option><option>12C</option>
                <option>12D</option><option>12E</option><option>12F</option>
            </select>
          </div>
          <div class="form-group">
          ...
          <div class="form-group full">
            ...
            <div style="display:flex;gap:6px;">
              ...
              <span style="font-size:1.5rem;cursor:pointer;" onclick="setRating(1)">⭐</span>
              <span style="font-size:1.5rem;cursor:pointer;" onclick="setRating(2)">⭐</span>
              <span style="font-size:1.5rem;cursor:pointer;" onclick="setRating(3)">⭐</span>
              <span style="font-size:1.5rem;cursor:pointer;" onclick="setRating(4)">⭐</span>
              <span style="font-size:1.5rem;cursor:pointer;" onclick="setRating(5)">⭐</span>
            </div>
          </div>
        </div>
...
<button id="scrollTop" aria-label="Scroll ke atas"><i class="fas fa-arrow-up"></i></button>
