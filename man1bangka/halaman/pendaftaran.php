        ...
        <div id="daftar-ekskul-tab" class="tab-panel active">
          <div class="form-card reveal">
            ...
            <form id="form-daftar-ekskul" autocomplete="off">
              <input type="hidden" name="ekstrakurikuler_id" value="1" />
              <div class="form-grid">
                ...
                <div class="form-group">
                  ...
                  >
                    ...
                    <option value="3">Bola Basket</option>
                    <option value="4">Karya Ilmiah Remaja (KIR)</option>
                    <option value="5">Seni Tari</option>
                    <option value="6">Robotika</option>
                  </select>
                </div>
                <div class="form-group">
                ...
                <div class="form-group full">
                  ...
                  <textarea
                    ...
                    name="alasan"
                    rows="4"
                    placeholder="Ceritakan alasan dan motivasimu bergabung di ekskul ini..."
                  ></textarea>
                </div>
              </div>
              <div
