...
<body>
        ...
        <form onsubmit="submitKontak(event)" autocomplete="off">
          <div class="form-grid">
            <div class="form-group">
              <label>Nama <span>*</span></label><input
                class="form-control"
                name="nama"
                required
            ...
            <div class="form-group">
              <label>Kelas</label><select class="form-control" name="kelas">
            ...
            <div class="form-group full">
              <label>Subjek <span>*</span></label><input
                class="form-control"
                name="subjek"
                required
            ...
            <div class="form-group full">
              <label>Pesan <span>*</span></label><textarea
                class="form-control"
                name="pesan"
                rows="5"
                required
  ...
  <script>
    document.addEventListener("DOMContentLoaded", () => {
      loadKontak();
      // initReveal() already called by main.js
    });
